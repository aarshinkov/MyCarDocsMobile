...
import bg.forcar.mobile.activities.fuel.FuelExpenseCreateActivity;
...
import bg.forcar.mobile.adapters.FuelExpenseAdapter;
...
import static bg.forcar.mobile.utils.Utils.getWholeNumberFormatted;
